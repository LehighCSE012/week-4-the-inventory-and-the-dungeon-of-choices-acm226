...
def enter_dungeon(player_health, inventory, dungeon_rooms):
    for room, item, challenge_type, challenge_outcome in dungeon_rooms:
        print(room)
        if item:
        ...
        if challenge_type == "puzzle":
            ...
            player_health += challenge_outcome[0] if input("Solve the puzzle? (y/n) ") == "y" else challenge_outcome[1]
